...
public class Semester_Selection extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		for (int i = 0; i < Data.createdSemesters.size(); i++) {
			...
			// for(int j = 0; j <
			// Data.createdSemesters.get(i).getCourses().size(); j++) {
			...
			// values[i] = Data.createdSemesters.get(i).getSession().toString()
			...
			if (Data.createdSemesters.get(i).getCourses().size() != 0) {
				...
				Data.createdSemesters.get(i).computeGPA(
						Data.createdSemesters.get(i).getCourses());
			}
			semesterGPA = "TGPA:" + Data.createdSemesters.get(i).getGPA();

			if (Data.createdSemesters.get(i).getComments().equals("") == false) {
				values[i] = Data.createdSemesters.get(i).getSession()
						.toString()
						+ " "
						+ Data.createdSemesters.get(i).getYear()
						+ " "
						...
						+ "\n"
						+ "Comments: "
						+ Data.createdSemesters.get(i).getComments();
			} else {
				values[i] = Data.createdSemesters.get(i).getSession()
						.toString()
						+ " "

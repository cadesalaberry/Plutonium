	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		percentLow.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,
					int arg2, long arg3) {
				// TODO Auto-generated method stub
				percent1 = Double.parseDouble(arg0.getItemAtPosition(arg2)
						.toString());
			}
		...
		percentHigh.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> arg0, View arg1,
					int arg2, long arg3) {
				// TODO Auto-generated method stub
				percent2 = Double.parseDouble(arg0.getItemAtPosition(arg2)
						.toString());
			}
		...
		ok.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Button ok = (Button) errorPopUp
						.findViewById(R.id.grading_scheme_error_ok_button);
				...
				if (gradePointValue.compareTo("") == 0
						|| Double.parseDouble(gradePointValue) > 5) {
	...
	public Boolean percentageOverlapCheck(double low, double high) {
		...
		for (int i = 1; i < percentageList.length; i++) {
			if (percentageList[i][0] <= percentageList[i - 1][1]
					&& ((percentageList[i][0] != 0 || percentageList[i][1] != 0) && (percentageList[i - 1][0] != 0 || percentageList[i - 1][1] != 0))) {
				result = true;
				break;
			}
		}
